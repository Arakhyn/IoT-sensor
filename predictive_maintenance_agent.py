...
class PredictiveMaintenanceAgent:
    ...
    def train_model(self):
        ...
        try:
            ...
            self.logger.info(f"Precisión en prueba: {test_score:.3f}")
            
            # Guardar modelo
            joblib.dump(self.model, 'predictive_maintenance_model.joblib')
    ...
    def predict_maintenance(self, current_data):
        ...
        try:
            if self.model is None:
                self.model = joblib.load('predictive_maintenance_model.joblib')
