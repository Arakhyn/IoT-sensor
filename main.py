    ...
    def verify_dependencies(self):
        ...
        try:
            ...
            subprocess.check_call([
                self.python_path, "-m", "pip", "uninstall", "-y", "numpy"
            ])
            
            # Instalar numpy específicamente para Python 3.9
            subprocess.check_call([
                self.python_path, "-m", "pip", "install", "numpy==1.24.3"
            ])
            ...
            try:
                ...
                logger.error("Error verificando NumPy")
                return False
